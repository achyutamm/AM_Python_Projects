...
# strong_room_pdf_url = "https://docview.payableslockbox.com/docview/invoiceviewer.aspx?i=18991965&c=ASC_JAI&s=b6ab7cfc-9967-5ce5-49cf-7a87ec03e6b3"
...
strong_room_pdfs_link_path = r'C:\Python\Genric Invoice Downloader\Config\strong_room_pdfs_links.txt'
...
with open(strong_room_pdfs_link_path, 'r') as file:
    strong_room_pdf_url = file.readlines()
    print(strong_room_pdf_url)

for url in strong_room_pdf_url:
    ...
    invoice_id = extract_id_from_url(url)
    if invoice_id:

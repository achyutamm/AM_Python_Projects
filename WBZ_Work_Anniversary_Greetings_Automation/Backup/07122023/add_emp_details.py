...
async def show_add_data_form(request: Request, message: str = None):
    return templates.TemplateResponse("add_emp_details.html", {"request": request, "message": message})
...
async def add_data(
    ...
    try:
        ...
        return await show_add_data_form(request, message=message)  # Use await here
